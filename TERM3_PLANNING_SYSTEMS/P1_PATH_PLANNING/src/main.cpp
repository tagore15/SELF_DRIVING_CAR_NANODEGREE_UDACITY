      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            double left_velocity = 10000;
            double right_velocity = 10000;
            ...
            for (int i = 0; i < sensor_fusion.size(); i++)
            {
                ...
                if (d < (4*(lane+1)) && d > (4*(lane)) && (check_car_s > car_s) && check_car_s - car_s < 30)
                { // other car is in current lane of our car
                    current_lane_close = true;
                    //cout << "current lane closed" << endl;
                }
                else if (d > 4*(lane-1) && d < (4*(lane)) && (abs(check_car_s - car_s) < 40))
                { // other car is in left lane
                    if (check_car_s > car_s && check_speed < ref_vel)
                    {
                        if (left_velocity > check_speed)
                        {
                            left_velocity = check_speed;
                        }
                    }
                ...
                else if (d > (4*(lane+1)) && d < (4*(lane+2)) && (abs(check_car_s - car_s) < 30))
                {
                    if (check_car_s > car_s && check_speed < ref_vel)
                    {
                        if (right_velocity > check_speed)
                        {
                            right_velocity = check_speed;
                        }
